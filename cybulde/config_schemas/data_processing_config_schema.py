...
from cybulde.config_schemas.infrastructure import gcp_config_schema
...
class DataProcessingConfig:
    ...
    dvc_remote_repo: str = "https://github.com/SalihSarii/cybulde-data.git"
    dvc_data_folder: str = "data/raw"
    github_user_name: str = "SalihSarii"
    github_access_token_secret_id: str = "cybulde-data-github-access-token"

    infrastructure: gcp_config_schema.GCPConfig = gcp_config_schema.GCPConfig()
